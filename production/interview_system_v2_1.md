# Interview System V2.1 — The Complete Structured Products Interview Handbook

**Version**: 2.1
**Date**: 2026-06-25
**Audit**: Adversarial audit findings resolved (1 critical, 6 high, 5 medium, 1 low)
...
**CommSwap (Commodity Swap) — Complexity 3:** Exchanges fixed commodity price for floating market price. Basis risk (hedge vs actual commodity grade/location) is the key risk. §6.1: commodity day count conventions.
