# CORRELATION CONVENTION FRAMEWORK — V1.0.1 FINAL
...
**Supersedes:** `correlation_convention_framework.md`  
**Cross-reference:** This document is referenced by every correlation-related erratum item (E-01 through E-04, E-06, E-08, E-09).
...
**V1.0.1 errata E-09** corrects the NTD coupon scaling table (Desk Bible lines 17952-17955) to align all NTD rows with this framework. All N≥2 products are labeled SHORT correlation with economic explanations.
...
This sanity check was used to identify E-01, E-02, and E-08 (promoted R-01). All three exhibited the same Step 4 failure pattern.

---

*V1.0.1 Correlation Convention Framework | FINAL (package closure) | 2026-06-27*
