# MARKET CONVENTION GUIDE — V1.0.1
...
**Common error (V1.0 Part 6):** Saying the desk "sold protection via the short put." The desk BOUGHT protection. The investor sold it.
...
**V1.0.1 rule:** Always specify raw or hedged when describing a desk position. See `raw_vs_hedged_position_note.md`.

---

*V1.0.1 Market Convention Guide | Effective: 2026-06-27*
