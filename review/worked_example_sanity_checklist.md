# WORKED EXAMPLE SANITY CHECKLIST — V1.0.1
...
| 15 | **Correlation convention** | If correlation direction is mentioned, it uses the canonical MTM convention (or explicitly flags structural usage). See `correlation_convention_framework.md` | ☐ |
...
*V1.0.1 Worked Example Sanity Checklist | Effective: 2026-06-27*
